...
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
<header class="site-header" style="background: rgba(0, 0, 0, 0.85); backdrop-filter: blur(20px); border-bottom: 1px solid rgba(255, 255, 255, 0.1);">
	<div class="container" style="display: flex; justify-content: space-between; align-items: center;">
		<a href="<?php echo esc_url(home_url('/')); ?>" class="brand" aria-label="Admiral Gems Uruguay" style="color: white;">
			<span class="brand-mark" aria-hidden="true">
				<img src="<?php echo esc_url( get_theme_file_uri('assets/logo-transparent.png') ); ?>" alt="Admiral Gems Uruguay" style="height:56px; width:auto; display:block; filter: brightness(0) invert(1);">
			</span>
			<span class="brand-name">Admiral Gems Uruguay</span>
		</a>
		<nav style="display: flex; gap: 32px; align-items: center;">
			<a href="#featured" style="color: rgba(255,255,255,0.8); font-size: 14px; font-weight: 500; text-decoration: none;">Products</a>
			<a href="#gallery" style="color: rgba(255,255,255,0.8); font-size: 14px; font-weight: 500; text-decoration: none;">Gallery</a>
			<a href="#our-story" style="color: rgba(255,255,255,0.8); font-size: 14px; font-weight: 500; text-decoration: none;">About</a>
...
<div class="whatsapp-float" aria-label="WhatsApp">
	<a href="https://wa.me/59895052840?text=<?php echo rawurlencode('Hello, I need a wholesale quote for [quantity]kg of amethysts, quality [EXTRA/Q1/Q2/Q3], destination: [country]'); ?>" target="_blank" rel="noopener" aria-label="Contactar por WhatsApp +59895052840">
